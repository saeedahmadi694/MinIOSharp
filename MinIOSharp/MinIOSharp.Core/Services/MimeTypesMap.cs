...
namespace MinIOSharp.Core.Services
{
    public static class MimeTypesMap
    {
        ...
        {
            string key = _mimeTypeMap.Value.FirstOrDefault((KeyValuePair<string, string> x) => x.Value.Contains(mime)).Key;
            if (key != null)
            {
                return key;
            }
        ...
        public static string GetMimeType(string fileName)
        {
            ...
            {
                text = fileName.Substring(num + 1).ToLower();
            }

            if (_mimeTypeMap.Value.TryGetValue(text, out var value))
            {
                return value;
            }
